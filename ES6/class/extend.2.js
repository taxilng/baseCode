    ...
    ! function () {
        ...
        angular.module("Controllers").controller("loginController", ["$scope", "loginFactory", "utilFactory", "reportService", "monitorService", function (e, t, a, n, i) {
            ...
            if ($(".lang .lang-item").click(function (e) {
                ...
                var s;
                e.isAssociationLogin && (e.userAvatar = a.getLocalStorage().getItem("userAvatar")), e.showPrivacyTips = /wechat\.com/gi.test(location.host), e.associationLogin = function () {
            ...
            var _chatList = [],
                ...
                service = {
                    ...
                    _recalledMsgProcess: function (e) {
                        ...
                        if (i = utilFactory.encodeEmoji(i), o = utilFactory.xml2json(i.replace(/<br\/>/g, "")).revokemsg, 0 == o.msgid) {
